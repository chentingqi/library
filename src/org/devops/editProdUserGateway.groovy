...
def editProdUserGateway(service,ip){
    ...
    if (service == 'thirdpartyadapter'){
       if (ip == 'IP1'){sh """sh /data/GATEWAY/user_edit_fgateway.sh ta.url 172.31.129.84 8080 thirdpartyadapter"""}
       if (ip == 'IP2'){sh """sh /data/GATEWAY/user_edit_fgateway.sh ta.url 172.31.129.79 8080 thirdpartyadapter"""}
       if (ip == 'IP12'){sh """sh /data/GATEWAY/user_edit_fgateway.sh ta.url 172.31.129.79 172.31.129.84 8080 thirdpartyadapter"""}
    }
}
